...
from views.volunteer_for_event import VolunteerForEvent
...
def register_url_rules(app):
    ...
    app.add_url_rule(
        '/display/events', view_func=Events.as_view('events'))

    app.add_url_rule(
        '/create/event', view_func=CreateEvent.as_view('create_event'))

    app.add_url_rule(
        '/delete/event', view_func=DeleteEvent.as_view('delete_event'))

    app.add_url_rule(
        '/register/volunteer', view_func=VolunteerForEvent.as_view('volunter_for_event'))
